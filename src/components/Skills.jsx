...
const Skills = () => {
  const skillsData = [
    ...
    },
    {
      ...
      skills: ['React', 'Responsive Web Design', 'UI & UX Design', 'Tailwind'],
    },
    {
      category: 'Backend Frameworks & DevOps',
      skills: ['Django', 'Flask', 'Node.js', 'Express', 'FastAPI', 'Docker', 'Cloud', 'CI/CD', 'Caching'],
    },
    {
      category: 'Databases',
      skills: ['Supabase', 'MongoDB', 'SQLite'],
    },
    {
      category: 'AI / Machine Learning',
      skills: ['Llama 3', 'Groq LLM API', 'Random Forest', 'TF-IDF', 'Scikit-learn', 'Pandas'],
    },
    {
      category: 'Tools & Architecture',
      skills: ['Git', 'GitHub', 'VS Code', 'Browser Developer Tools', 'REST API Integration', 'Microservices Architecture', 'Authentication & Security'],
    },
  ];
