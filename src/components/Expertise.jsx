      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            ...
            text="Crafting responsive web applications with React, HTML5, CSS3, Tailwind CSS, and modern UI/UX design principles optimized across all device form factors."
          ...
          <TagCard
            ...
            text="Architecting decoupled dual-service platforms using Node.js, Express, Django, Flask, FastAPI, REST APIs, JWT authentication, and microservice architectures."
          ...
          <TagCard
            ...
            text="Engineering intelligent systems using Llama 3, Groq LLM API, NLP pipelines, Random Forest, TF-IDF, Scikit-learn, Pandas, and real-time streaming extraction." 
          ...
          <TagCard
            ...
            text="Managing Supabase, MongoDB, and SQLite databases alongside containerized deployments with Docker, cloud setups, caching, and CI/CD workflows."
